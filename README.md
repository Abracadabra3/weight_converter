...
## Quick start
1. Download weight_converter.exe from the [Releases](https://github.com/Abracadabra3/weight_converter/releases/tag/V1) page
1. Run the file

Or if you don't want to download the .exe:

1. Run `pip install pyinputplus` in your python environment
1. Download weight_converter.py from the [Releases](https://github.com/Abracadabra3/weight_converter/releases/tag/V1) page (or copy and paste the code) and run the file.
## Features
